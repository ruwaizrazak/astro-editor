...
describe('Editor Commands', () => {
  ...
  describe('createLinkCommand', () => {
    it('should create a command that creates markdown links', () => {
      const { createMarkdownLink } = vi.mocked(await import('../markdown/formatting'))
  ...
  describe('createEditorCommandRegistry', () => {
    ...
    it('should have working createLink command', () => {
      const mockSave = vi.fn()
      const registry = createEditorCommandRegistry(mockSave)
      const { createMarkdownLink } = vi.mocked(await import('../markdown/formatting'))
